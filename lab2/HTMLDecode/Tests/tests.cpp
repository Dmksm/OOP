...
//классы эквивалентности почитать, не использовать лишние тесты, проверять классы эквивалетности, писать тесты до кода подход тест дривен девелопмент
//можно изменить логику программы и тесты должны отловить ошибку
